...
def argument_parser():
    ...
    parser.add_argument(
        "--train_data",
        default="/shared/3/projects/hiatus/tagged_data/mlm_finetuning/train/",
        type=str,
    )
    parser.add_argument(
        "--dev_data",
        default="/shared/3/projects/hiatus/tagged_data/mlm_finetuning/dev/",
        type=str,
    )
    parser.add_argument(
        "--out_dir", type=str, default="/shared/3/projects/hiatus/models/style-mlm/"
    )
