...
def argument_parser():
    ...
    parser.add_argument(
        "--en_train_file",
        default="/shared/3/projects/hiatus/tagged_data/mlm_finetuning/train.jsonl",
        type=str,
    )
    parser.add_argument(
        "--en_dev_file",
        default="/shared/3/projects/hiatus/tagged_data/mlm_finetuning/dev.jsonl",
        type=str,
    )
    parser.add_argument(
        "--train_file",
        default="/shared/3/projects/hiatus/multilingual/train.jsonl",
        type=str,
    )
    parser.add_argument(
        "--dev_file",
        default="/shared/3/projects/hiatus/multilingual/dev.jsonl",
        type=str,
    )
    parser.add_argument(
        "--out_dir", type=str, default="/shared/3/projects/hiatus/models/multilingual/"
    )
    ...
    parser.add_argument(
        "--code_dir", default="src/custom_training/mlm_finetuning", type=str
    )
